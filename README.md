...
Одна сторінка, сім мов, фільтр алергенів, QR і NFC. Хостинг — GitHub Pages, безкоштовно.
...
```json
{
  "p": "6,80",
  "alg": ["gluten","lacteos"],
  "n": { "es": "...", "en": "...", "de": "...", "fr": "...", "nl": "...", "it": "...", "uk": "..." },
  "d": { "es": "...", "en": "...", "de": "...", "fr": "...", "nl": "...", "it": "...", "uk": "..." },
  "pop": true
}
```
...
- **7 мов** з автовизначенням за мовою телефона (es/en/de/fr/nl/it/uk)
